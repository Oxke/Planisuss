...
class World:
    ...
    def get_adjacent(self, cell: Cell):
        ...
        adjacent_cells = [self.grid[x][y] for x, y in itertools.product([cell.x-1, cell.x+1], [cell.y-1, cell.y+1])]
        return [cell for cell in adjacent_cells if 0 <= cell.x < self.num_cells and 0 <= cell.y < self.num_cells]
